...
<xsl:stylesheet xmlns:html="http://www.w3.org/TR/REC-html40" xmlns:sitemap="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
    ...
    <xsl:template match="/">
        <html>
            <head>
                <title>Human Tissue Authority - Sitemap</title>
                <script type="text/javascript" src="https://www.hta.gov.uk/static/_sitemap/jquery.js"/>
                <script type="text/javascript" src="https://www.hta.gov.uk/static/_sitemap/jquery.tablesorter.min.js"/>
                <script type="text/javascript" src="https://www.hta.gov.uk/static/_sitemap/xmlsitemap.xsl.js"/>
                <link href="https://www.hta.gov.uk/static/_sitemap/scss/css/sitemap.css" type="text/css" rel="stylesheet"/>
            </head>
            <!--
            ...
            <body>
                <div class="sitemap-wrapper">
                    <a class="logo" href="https://www.hta.gov.uk" title="Visit Homepage"><img src="https://www.hta.gov.uk/static/_sitemap/logo.png" alt="Human Tissue Authority - Small Logo"/></a>
                    <h1>Sitemap file</h1>
                    <xsl:choose>
