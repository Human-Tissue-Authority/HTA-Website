              ...
              <Form>
                ...
                <fieldset>
                  ...
                  <div className={`field field--last_name ${errors.last_name ? 'field--invalid' : ''}`}>
                    ...
                    <Field id="last_name" type="text" name="last_name" autoComplete="family-name" />
                  ...
                  <div className={`field field--email_address ${errors.email_address ? 'field--invalid' : ''}`}>
                    ...
                    <Field id="email_address" type="email" name="email_address" autoComplete="email" />
                  ...
                  <div className={`field field--confirm_email_address ${errors.confirm_email_address ? 'field--invalid' : ''}`}>
                    ...
                    <Field id="confirm_email_address" type="email" name="confirm_email_address" />
                  ...
                  <div className={`field field--consent ${errors.i_would_like_to_be_notified_when_any_new_reports_are_uploaded_fo ? 'field--invalid' : ''}`}>
                    <div className="field__inner-wrapper">
                      <Field id="consent" type="checkbox" name="i_would_like_to_be_notified_when_any_new_reports_are_uploaded_fo" />
                    ...
                    <ErrorMessage name="i_would_like_to_be_notified_when_any_new_reports_are_uploaded_fo" component="span" />
                  </div>
                </fieldset>
